    ...
    return (
        <>
            <div>
                ...
                <div style={ContentStyle}>
                    ...
                    <div style={{ marginTop: '130px', width: '50%' }}>
                        <Form style={FormStyle} onFinish={handleLogin}>
                            <div style={{ width: '70%', margin: 'auto', marginTop: '40px' }}>
                                <Input className='form-control' placeholder='Email hoặc số điện thoại' name='inputEmail' onChange={handleInputLogin} />
                            </div>
                            <div style={{ width: '70%', margin: 'auto', marginTop: '20px' }}>
                                <Input type='password' className='form-control' placeholder='Mật khẩu' name='inputPassword' onChange={handleInputLogin} />
                            </div>
                            <div style={{ width: '100%', marginTop: '20px', display: 'flex', justifyContent: 'center' }}>
                                <Button style={DangNhapButton} htmlType='submit'>Đăng Nhập</Button>
                            </div>
            ...
            <Modal
                ...
                okText="Đăng ký"
                onOk={handleRegister}
                onCancel={() => { setShowDangKy(false); setRegisterInput(""); setErrors(""); }}
            >
                <Form className='container w-100'>
                    <div className='row mb-3'>
                        <div className='col-lg-6'>
                            <Input type='' placeholder='Họ' className='form-control' name="inputHo" value={registerInput.inputHo} onChange={handleInputRegister} />
                            {errors.inputHo && (
                                <div
                        ...
                        <div className='col-lg-6'>
                            <Input type='text' placeholder='Tên' className='form-control' name="inputTen" value={registerInput.inputTen} onChange={handleInputRegister} />
                            {errors.inputTen && (
                                <div
                                    className="invalid-feedback"
                                    style={{ display: "block", color: "red" }}
                    ...
                    <div className='form-group mb-3'>
                        <Input type='email' placeholder='Email' className='form-control' name="inputEmail" value={registerInput.inputEmail} onChange={handleInputRegister} />
                        {errors.inputEmail && (
                            <div
                                className="invalid-feedback"
                                style={{ display: "block", color: "red" }}
                    ...
                    <div className='form-group mb-3'>
                        <Input type='text' placeholder='Số điện thoại' className='form-control' name="inputPhone" value={registerInput.inputPhone} onChange={(handleInputRegister)} />
                        {errors.inputPhone && (
                            <div
                                className="invalid-feedback"
                                style={{ display: "block", color: "red" }}
                    ...
                    <div className='form-group'>
                        <Input className="form-control" type="text" placeholder="Tên trường" name="inputSchoolName" value={registerInput.inputSchoolName} onChange={(handleInputRegister)} />
                    </div>
                </Form>
            </Modal>
            ...
            >
                <div className='mainAuth'>
                    ...
                    >
                        ...
                        <Form.Item>
                            <p style={{ textAlign: "center" }}>Bạn sẽ nhận được mật khẩu mới do chúng tôi cung cấp. Vui lòng vào email của bạn để nhận mật khẩu.</p>
                        </Form.Item>
