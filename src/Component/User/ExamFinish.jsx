...
export default function ExamFinish() {
    ...
    //#endregion
    const [testDetai, setTestDetail] = useState([]);
            ...
            <div className='exam-finish'>
                ...
                {testDetai.map((item) =>
                    <div className='exam-finish-result'>
                        ...
                        <hr></hr>
                        <p>Môn thi: <span>{item.subjectName}</span></p>
                        <p>Số câu hỏi: <span>{item.totalQuestion} câu</span></p>
                        <p>Thời gian: <span>{item.duration} phút</span></p>
