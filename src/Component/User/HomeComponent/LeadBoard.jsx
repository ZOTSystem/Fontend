...
import { GetTopicByTopicType, GetRankingOfTopic } from '../../../services/topicService'
        ...
        <>
            <div className='sc-ehSCib kYuMkW mb-5'>
                <h2 className='sc-AzgDb eXzbuF'>
                    <svg width="23" height="26" viewBox="0 0 23 26" fill="none"><path d="M9.43525 15.3323V24.7675H0C0 22.2651 0.994068 19.8652 2.76352 18.0958C4.53297 16.3263 6.93286 15.3323 9.43525 15.3323ZM16.5117 24.1778L13.0454 26L13.7071 22.141L10.9036 19.4071L14.7791 18.8434L16.5117 15.3323L18.2454 18.8434L22.1198 19.4071L19.3163 22.141L19.9768 26L16.5117 24.1778ZM9.43525 14.1529C5.52552 14.1529 2.35881 10.9862 2.35881 7.07643C2.35881 3.1667 5.52552 0 9.43525 0C13.345 0 16.5117 3.1667 16.5117 7.07643C16.5117 10.9862 13.345 14.1529 9.43525 14.1529Z" fill="#FFC000"></path></svg>
                    <span>Bảng xếp hạng</span>
                </h2>
                <div className='sc-gsTCUz gQRQLT' style={{ justifyContent: 'space-around' }}>
                                    ...
                                    <div className='sc-kIeTtH cnxSGb'>
                                        <div className='d-sm-flex justify-content-between d-none'>
                                            <div className='sc-dacFzL dOuBXx'>
                                                ...
                                                <p style={{ marginTop: '20px', marginBottom: 0 }}>{ranking[1]?.fullName}</p>
                                                <i style={{ marginTop: 5 }}>{ranking[1]?.score} điểm</i>
                                            </div>
                                            ...
                                            <div className='sc-dacFzL kAYTCb'>
                                                ...
                                                <p style={{ marginTop: '20px', marginBottom: 0 }}>{ranking[2]?.fullName}</p>
                                                <i style={{ marginTop: 5 }}>{ranking[2]?.score} điểm</i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className='sc-dlfnbm sc-eCssSg dcHHcO oDHHe'>
                        <div className='sc-aemoO hgHGyw'>
                            <div className='sc-jONnTn jIvnOH'>
                                <p class="sc-eLgOdN ejJoEn d-sm-inline-block d-none" style={{ color: '#000000' }}>Số bài kiểm tra đã làm</p>
                                <div>
                                    <div className='sc-kIeTtH cnxSGb'>
                                        <div className='d-sm-flex justify-content-between d-none'>
                                            <div className='sc-dacFzL dOuBXx'>
                                                ...
                                                <p style={{ marginTop: '20px', marginBottom: 0 }}>{userHard[2]?.fullName}</p>
                                                <i style={{ marginTop: 5 }}>{userHard[2]?.totalTest} bài</i>
                                            </div>
                                            <div className='sc-dacFzL HrxDC'>
                                                <div className='sc-dtwoBo bkcwRn'>
                                                    <img src="../Image/Avatar_Null.png" alt="" />
                                                ...
                                                <p style={{ marginTop: '20px', marginBottom: 0 }}>{userHard[0]?.fullName}</p>
                                                <i style={{ marginTop: 5 }}>{userHard[0]?.totalTest} bài</i>
                                            </div>
                                            <div className='sc-dacFzL kAYTCb'>
                                                <div className='sc-dtwoBo iLzkhh'>
                                                    <img src="../Image/Avatar_Null.png" alt="" />
                                                ...
                                                <p style={{ marginTop: '20px', marginBottom: 0 }}>{userHard[1]?.fullName}</p>
                                                <i style={{ marginTop: 5 }}>{userHard[1]?.totalTest} bài</i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
